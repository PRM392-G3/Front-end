...
import { PostResponse, groupAPI, Group } from '@/services/api';
...
interface CreateGroupPostScreenProps {
  onClose: () => void;
...
export default function CreateGroupPostScreen({ 
  ...
  const handleCreatePost = async () => {
    ...
    try {
      ...
      const newPost = await groupAPI.createGroupPost(groupId, postData);
  ...
  const handleImageUpload = (result: any) => {
    console.log('CreateGroupPostScreen: Image upload result:', result);
    setSelectedImages([result.publicUrl]);
  };

  const handleVideoUpload = (url: string) => {
    console.log('CreateGroupPostScreen: Video upload result:', url);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        ...
        <Text style={styles.headerTitle}>Đăng bài trong nhóm</Text>
        <TouchableOpacity
        ...
        <View style={styles.userInfo}>
          ...
          <View style={styles.userDetails}>
            ...
            <View style={styles.groupInfo}>
              <Text style={styles.postingToText}>Đăng trong </Text>
